...
@SpringBootTest
class PhoneInitializerTest {

    @Autowired
    PhoneInitializer phoneInitializer;
    @Autowired
    ConvenienceFunctionInitializer convenienceFunctionInitializer;
    @Autowired
    ManufacturerInitializer manufacturerInitializer;
    @Autowired
    ...
    void convertJsonFileToPhoneModel(String resource, String networkTechName) {
        Map<String, PhoneModel> phoneModels = phoneInitializer.convertJsonToPhoneModels(resource, networkTechName);
    ...
    void setPhoneSizeAtOnce() {
        ...
        phoneInitializer.initSize(phoneModelMap);
    ...
    void setPhoneWeightAtOnce() {
        ...
        phoneInitializer.initWeight(phoneModelMap);
    ...
    void setPhoneInfosAtOnce() {
        ...
        phoneInitializer.initInfo(phoneModelMap);
    ...
    void setReleaseDateAtOnce() {
        ...
        phoneInitializer.initReleaseDate(phoneModelMap);
    ...
    void setPhoneFunctionsAtOnce() {
        ...
        phoneInitializer.initConvenienceFunction(phoneModelMap);
    ...
    void setThumbnailAtOnce() {
        ...
        phoneInitializer.initThumbnail(phoneModelMap);
    ...
    private Map<String, PhoneModel> createPhoneModelMap() {
        ...
        Map<String, PhoneModel> phoneModels = phoneInitializer.convertJsonToPhoneModels(resource1, "5G");
        phoneModels.putAll(phoneInitializer.convertJsonToPhoneModels(resource2, "LTE"));
        phoneInitializer.deletePhonesForInit(phoneModels);
        return phoneModels;
    }
